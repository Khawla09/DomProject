...
var menuLinks = [
  ...
  },
  {
    ...
    href: "#",
    subLinks: [
      { text: "Login", href: "loginForm.html", target: "_blank" },
      { text: "sign up", href: "registerForm.html", target: "_blank" },
    ],
  },
];
let mainEl = document.querySelector("main");
// mainEl.style.backgroundColor = "var(--main-bg)";
// mainEl.innerHTML = "<h1>Make your List</h1>";
mainEl.classList = "flex-ctr";
// const  = '<nav id="top-menu">';
const topMenuEl = document.querySelector("#top-menu");
topMenuEl.style.height = "100%";
// topMenuEl.style.backgroundColor = "rgb(158, 41, 41)";
